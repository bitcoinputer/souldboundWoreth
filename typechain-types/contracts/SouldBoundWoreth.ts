...
export interface SouldBoundWorethInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface SouldBoundWoreth extends BaseContract {
  connect(runner?: ContractRunner | null): SouldBoundWoreth;
  waitForDeployment(): Promise<this>;

  interface: SouldBoundWorethInterface;
